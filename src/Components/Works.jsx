        ...
        <div className="works__section" id="works__section">
            ...
            <div className="cards__container">   
                <div className="card__project">
                    <a href="https://kind-lamport-2f43d2.netlify.app">
                    ...
                    <div className="buttons__card__position">
                        <a href="https://kind-lamport-2f43d2.netlify.app">See more</a>
                        <a href="https://github.com/pedroYan92/pedroYan92.github.io">Source code</a></div>                
                </div>
                <div className="card__project">
                    <a href="https://silly-rosalind-7650d3.netlify.app">
                    ...
                    <div className="buttons__card__position">
                        <a href="https://silly-rosalind-7650d3.netlify.app">See more</a>
                        <a href="https://github.com/pedroYan92/Search-Book-project">Source code</a></div>                
                </div>
                <div className="card__project">
                    <a href="https://relaxed-lamarr-2bdfd7.netlify.app">
                    ...
                    <div className="buttons__card__position">
                        <a href="https://relaxed-lamarr-2bdfd7.netlify.app">See more</a>
